...
CREATE OR REPLACE FUNCTION st_geometry_analyze(internal)
	RETURNS bool
	AS '$libdir/postgis-2.0', 'LWGEOM_analyze'
...
CREATE OR REPLACE FUNCTION box3d_extent_out(box3d_extent)
	RETURNS cstring
	AS '$libdir/postgis-2.0', 'BOX3D_extent_out'
	LANGUAGE c IMMUTABLE STRICT;
...
CREATE OR REPLACE FUNCTION box3d_extent(box3d_extent)
	RETURNS box3d
	AS '$libdir/postgis-2.0', 'BOX3D_extent_to_BOX3D'
	LANGUAGE c IMMUTABLE STRICT;

CREATE OR REPLACE FUNCTION box2d(box3d_extent)
	RETURNS box2d
	AS '$libdir/postgis-2.0', 'BOX3D_to_BOX2DFLOAT4'
	LANGUAGE c IMMUTABLE STRICT;
...
CREATE OR REPLACE FUNCTION chip_in(cstring)
	RETURNS chip
	AS '$libdir/postgis-2.0','CHIP_in'
	LANGUAGE c IMMUTABLE STRICT;

CREATE OR REPLACE FUNCTION chip_out(chip)
	RETURNS cstring
	AS '$libdir/postgis-2.0','CHIP_out'
	LANGUAGE c IMMUTABLE STRICT;
...
CREATE OR REPLACE FUNCTION st_box2d_in(cstring)
	RETURNS box2d
	AS '$libdir/postgis-2.0','BOX2DFLOAT4_in'
	LANGUAGE c IMMUTABLE STRICT;

-- Deprecation in 1.5.0
CREATE OR REPLACE FUNCTION st_box2d_out(box2d)
	RETURNS cstring
	AS '$libdir/postgis-2.0','BOX2DFLOAT4_out'
	LANGUAGE c IMMUTABLE STRICT;
...
CREATE OR REPLACE FUNCTION postgis_gist_sel (internal, oid, internal, int4)
	RETURNS float8
	AS '$libdir/postgis-2.0', 'LWGEOM_gist_sel'
	LANGUAGE c;

-- Deprecation in 1.5.0
CREATE OR REPLACE FUNCTION postgis_gist_joinsel(internal, oid, internal, smallint)
	RETURNS float8
	AS '$libdir/postgis-2.0', 'LWGEOM_gist_joinsel'
	LANGUAGE c;
...
CREATE OR REPLACE FUNCTION getsrid(geometry)
	RETURNS int4
	AS '$libdir/postgis-2.0','LWGEOM_getSRID'
	LANGUAGE c IMMUTABLE STRICT;
...
CREATE OR REPLACE FUNCTION srid(chip)
	RETURNS int4
	AS '$libdir/postgis-2.0','CHIP_getSRID'
	LANGUAGE c IMMUTABLE STRICT;
...
CREATE OR REPLACE FUNCTION height(chip)
	RETURNS int4
	AS '$libdir/postgis-2.0','CHIP_getHeight'
	LANGUAGE c IMMUTABLE STRICT;
...
CREATE OR REPLACE FUNCTION factor(chip)
	RETURNS FLOAT4
	AS '$libdir/postgis-2.0','CHIP_getFactor'
	LANGUAGE c IMMUTABLE STRICT;
...
CREATE OR REPLACE FUNCTION width(chip)
	RETURNS int4
	AS '$libdir/postgis-2.0','CHIP_getWidth'
	LANGUAGE c IMMUTABLE STRICT;
...
CREATE OR REPLACE FUNCTION datatype(chip)
	RETURNS int4
	AS '$libdir/postgis-2.0','CHIP_getDatatype'
	LANGUAGE c IMMUTABLE STRICT;
...
CREATE OR REPLACE FUNCTION compression(chip)
	RETURNS int4
	AS '$libdir/postgis-2.0','CHIP_getCompression'
	LANGUAGE c IMMUTABLE STRICT;
...
CREATE OR REPLACE FUNCTION setSRID(chip,int4)
	RETURNS chip
	AS '$libdir/postgis-2.0','CHIP_setSRID'
	LANGUAGE c IMMUTABLE STRICT;

-- Deprecation in 1.2.3
CREATE OR REPLACE FUNCTION setFactor(chip,float4)
	RETURNS chip
	AS '$libdir/postgis-2.0','CHIP_setFactor'
	LANGUAGE c IMMUTABLE STRICT;
...
CREATE OR REPLACE FUNCTION expand(box2d,float8)
	RETURNS box2d
	AS '$libdir/postgis-2.0', 'BOX2DFLOAT4_expand'
	LANGUAGE c IMMUTABLE STRICT;
...
CREATE OR REPLACE FUNCTION ForceRHR(geometry)
	RETURNS geometry
	AS '$libdir/postgis-2.0', 'LWGEOM_forceRHR_poly'
	LANGUAGE c IMMUTABLE STRICT;
...
CREATE OR REPLACE FUNCTION MakeBox2d(geometry, geometry)
	RETURNS box2d
	AS '$libdir/postgis-2.0', 'BOX2DFLOAT4_construct'
	LANGUAGE c IMMUTABLE STRICT;
...
CREATE OR REPLACE FUNCTION BuildArea(geometry)
	RETURNS geometry
	AS '$libdir/postgis-2.0', 'LWGEOM_buildarea'
	LANGUAGE c IMMUTABLE STRICT
	COST 100;
...
CREATE OR REPLACE FUNCTION combine_bbox(box2d,geometry)
	RETURNS box2d
	AS '$libdir/postgis-2.0', 'BOX2DFLOAT4_combine'
...
CREATE OR REPLACE FUNCTION estimated_extent(text,text,text) RETURNS box2d AS
	'$libdir/postgis-2.0', 'LWGEOM_estimated_extent'
...
CREATE OR REPLACE FUNCTION st_box3d(box2d)
	RETURNS box3d
	AS '$libdir/postgis-2.0','BOX2DFLOAT4_to_BOX3D'
	LANGUAGE c IMMUTABLE STRICT;
...
CREATE OR REPLACE FUNCTION st_geometry(box2d)
	RETURNS geometry
	AS '$libdir/postgis-2.0','BOX2DFLOAT4_to_LWGEOM'
	LANGUAGE c IMMUTABLE STRICT;
...
CREATE OR REPLACE FUNCTION st_geometry(chip)
	RETURNS geometry
	AS '$libdir/postgis-2.0','CHIP_to_LWGEOM'
	LANGUAGE c IMMUTABLE STRICT;
...
CREATE OR REPLACE FUNCTION Equals(geometry,geometry)
	RETURNS boolean
	AS '$libdir/postgis-2.0','geomequals'
	LANGUAGE c IMMUTABLE STRICT;
...
CREATE OR REPLACE FUNCTION AsSVG(geometry,int4,int4)
	RETURNS TEXT
	AS '$libdir/postgis-2.0','assvg_geometry'
	LANGUAGE c IMMUTABLE STRICT;
...
CREATE OR REPLACE FUNCTION IsClosed(geometry)
	RETURNS boolean
	AS '$libdir/postgis-2.0', 'LWGEOM_isclosed_linestring'
	LANGUAGE c IMMUTABLE STRICT;
...
CREATE OR REPLACE FUNCTION SetSRID(geometry,int4)
	RETURNS geometry
	AS '$libdir/postgis-2.0','LWGEOM_setSRID'
	LANGUAGE c IMMUTABLE STRICT;
...
--    RETURNS bytea
--    AS '$libdir/postgis-2.0','LWGEOM_AsShape'
--    LANGUAGE c IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION geography_typmod_out(integer)
	RETURNS cstring
	AS '$libdir/postgis-2.0','geography_typmod_out'
	LANGUAGE c IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION ST_AsText(geography)
	RETURNS text
	AS '$libdir/postgis-2.0','geography_as_text'
	LANGUAGE c IMMUTABLE STRICT;
...
CREATE OR REPLACE FUNCTION ST_AsBinary(geography)
	RETURNS bytea
	AS '$libdir/postgis-2.0','geography_as_binary'
	LANGUAGE c IMMUTABLE STRICT;
...
CREATE OR REPLACE FUNCTION geography_typmod_dims(integer)
	RETURNS integer
	AS '$libdir/postgis-2.0','geography_typmod_dims'
	LANGUAGE c IMMUTABLE STRICT;

-- Availability: 1.5.0
CREATE OR REPLACE FUNCTION geography_typmod_srid(integer)
	RETURNS integer
	AS '$libdir/postgis-2.0','geography_typmod_srid'
	LANGUAGE c IMMUTABLE STRICT;

-- Availability: 1.5.0
CREATE OR REPLACE FUNCTION geography_typmod_type(integer)
	RETURNS text
	AS '$libdir/postgis-2.0','geography_typmod_type'
	LANGUAGE c IMMUTABLE STRICT;
...
CREATE OR REPLACE FUNCTION geography_gist_join_selectivity(internal, oid, internal, smallint)
	RETURNS float8
	AS '$libdir/postgis-2.0', 'geography_gist_join_selectivity'
	LANGUAGE c;

-- Availability: 1.5.0
CREATE OR REPLACE FUNCTION geography_overlaps(geography, geography) 
	RETURNS boolean 
	AS '$libdir/postgis-2.0' ,'geography_overlaps'
	LANGUAGE c IMMUTABLE STRICT;
